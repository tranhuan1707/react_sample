...
class RoleplayAudioRecord extends React.Component {
  state = {
    isMounted: false,
  };
  ...
  componentWillReceiveProps(nextProps) {
    if(nextProps.autoRecord && nextProps.autoRecord === true) {
      let _this = this;
      ...
      // setTimeout(function() {
      //   _this.props.resetAutoPlayRecord();
      // }, 1000);
    }
  }
  ...
  onStop(blobObject) {
    // console.log('blobObject', blobObject);
      ...
      this.props.onSaveRecord(blobObject);
  }
...
export default withStyles(s)(RoleplayAudioRecord);