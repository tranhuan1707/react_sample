...
class VideoAutoplay extends React.Component {
    constructor(props) {
        super(props)
    }
    componentDidMount() {
    ...
    componentWillReceiveProps(nextProps) {
        if(nextProps.playerTime && nextProps.playerTime !== null) {
            ...
            if(nextProps.stopVideo !== true) {
                ...
                $('#' + this.props.videoId + '.vd-play .saudio-play.pause').css('display', 'inline-block');
            }
        }
    }
...
export default withStyles(s)(VideoAutoplay);
