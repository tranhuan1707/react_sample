...
class WordCardItem extends React.Component {
    static propTypes = {
                ...
                <div className="saudio-word">
                    ...
                    className={"aud-play " + s.lword}>
                        ...
                        <div className={"sword-ct " + s.new_word}>
                            ...
                            && <div className="pron"
                            dangerouslySetInnerHTML={{__html: cardItmData.json.vietnamese}}
                            ></div>}
                        </div>
                    </div>
                </div>
...
export default withStyles(s)(WordCardItem)